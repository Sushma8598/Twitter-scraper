...
print(df_dict)
py = MongoClient("mongodb://Shiva:password@ac-hiwwfdi-shard-00-00.nzfu3wg.mongodb.net:27017,ac-hiwwfdi-shard-00-01.nzfu3wg.mongodb.net:27017,ac-hiwwfdi-shard-00-02.nzfu3wg.mongodb.net:27017/?ssl=true&replicaSet=atlas-i0xspt-shard-0&authSource=admin&retryWrites=true&w=majority")
py1 = py["MongoClient"]
py2 = py["tweet"]
